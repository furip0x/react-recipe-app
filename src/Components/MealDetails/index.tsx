          ...
          <div className="flex flex-wrap">
            <div className="w-full mb-7 md:w-5/12 md:pr-10 sm:mb-0">
              <div className="sticky top-5">
                <div className="relative">
                  <button
                    onClick={updateMeal}
                    className={`absolute top-3 right-3 z-10 w-10 h-10 inline-flex items-center justify-center p-3 text-amber-500 bg-white rounded-full transition hover:text-amber-500 hover:bg-white ${
            ...
            <div className="w-full md:w-7/12">
                  ...
                  {mealData?.ingredients.map(
                    (ingredient: Ingredient, index) => {
                      return (
                        <div
                          key={index}
                          className="flex flex-col gap-y-1 text-center text-xl bg-gray-100 p-4 rounded-xl transition hover:bg-lime-300 hover:drop-shadow-md hover:-translate-y-1"
                        >
                          <img
                            className="w-full"
              ...
              <div className="w-full pt-9">
                ...
                <p className="text-base">{mealData?.instructions}</p>
              </div>
            </div>
          </div>
        ) : null}
